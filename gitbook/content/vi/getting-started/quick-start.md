...
Khởi chạy StaliRouter trong 5 phút và bắt đầu định tuyến các request AI một cách thông minh.
...
Trỏ công cụ code của bạn tới StaliRouter:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from stalirouter dashboard]
...
```json
{
  ...
  "anthropic_api_key": "your-stalirouter-api-key"
}
```
...
export OPENAI_API_KEY="your-stalirouter-api-key"
