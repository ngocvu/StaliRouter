...
Hướng dẫn cài đặt chi tiết cho StaliRouter với mẹo troubleshooting.
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `stalirouter`
- ✅ Auto-update với `npm update -g stalirouter`
...
3. Data directory được tạo tại `~/.stalirouter`
...
**Vấn đề:** StaliRouter dùng quá nhiều RAM
