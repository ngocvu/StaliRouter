---
name: stalirouter-web-fetch
description: Fetch URL → markdown / text / HTML via StaliRouter /v1/web/fetch using Firecrawl / Jina Reader / Tavily Extract / Exa Contents. Use when the user wants to scrape a webpage, extract URL content, read article, or convert a URL to markdown.
---

# StaliRouter — Web Fetch
...
curl -X POST $NINEROUTER_URL/v1/web/fetch \
  ...
  -d '{"model":"jina-reader","url":"https://stalirouter.com","format":"markdown"}'
```
